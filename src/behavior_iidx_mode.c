...
/* Keyboard mode is the default; holding the boot-select key enables IIDX mode. */
...
static int on_pressed(struct zmk_behavior_binding *binding,
    ...
    /* Release both interfaces before changing how subsequent key events are routed. */
